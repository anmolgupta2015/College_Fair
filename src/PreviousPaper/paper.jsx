...
import ImageViewer from "@/ProductDetails/ImageViewer"
...
function PaperDetails() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen py-4 px-4 sm:py-8 relative">
      <div className="max-w-7xl mx-auto">
        {/* Breadcrumb */}
        <nav className="mb-6 text-sm text-gray-500"></nav>

        {/* Main content */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
          {/* Left column - Paper preview */}
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl shadow-md overflow-hidden border border-gray-100 h-fit">
              {/* Paper header */}
              ...
              <div className="relative bg-gray-50 border-b border-gray-100">
                <div
                  className="aspect-[3/4] sm:aspect-[4/3] flex items-center justify-center overflow-hidden cursor-pointer"
                  onClick={() => setImageViewerShow(true)}
                >
                  ...
                  <div className="flex space-x-2 overflow-x-auto pb-2">
                    {validImages.map((img, index) => (
                      <button
                        ...
                        className={`flex-shrink-0 w-16 h-16 rounded-md overflow-hidden border-2 cursor-pointer hover:opacity-80 transition-opacity ${currentImageIndex === index ? "border-purple-500" : "border-transparent hover:border-purple-200"}`}
                      >
                        <img
              ...
              <div className="p-4 flex flex-wrap items-center justify-between gap-4">
                ...
                <button
                  ...
                  disabled={load1}
                  className="px-5 py-2.5 bg-purple-600 hover:bg-purple-700 text-white rounded-lg shadow-sm transition-colors flex items-center gap-2"
                >
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-md border border-gray-100 sticky top-6">
              <div className="p-6 border-b border-gray-100">
              ...
              <div className="p-6 bg-purple-50 rounded-b-2xl">
                ...
                <p className="text-sm text-purple-700">
                  This question paper is from {paperData.subject} ({paperData.courseId}) for {paperData.branch}{" "}
                  students. It contains {validImages.length} pages of questions and can be downloaded for offline study.
                </p>
              </div>
            </div>
          </div>
      ...
      {ImageViewerShow && (
        <div className="fixed inset-0 z-[9999]">
          <ImageViewer
            ...
            isOpen={ImageViewerShow}
            onClose={() => setImageViewerShow(false)}
          />
        </div>
      )}
    </div>
